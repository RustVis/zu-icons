...
pub struct HandsAmericanSignLanguageInterpretingProps {
    #[props(default = None)]
...
pub fn HandsAmericanSignLanguageInterpreting(props: HandsAmericanSignLanguageInterpretingProps) -> Element {
    rsx! {
        svg {
            class: props.class,
            style: props.style,
